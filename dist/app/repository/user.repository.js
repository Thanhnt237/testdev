...
exports.getAllVote = exports.vote = exports.addUser = exports.getUser = void 0;
...
function addUser(input) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let sql = common.genInsertQuery(tablename_1.TABLE_NAME.USER, arrProps, input);
        try {
...
function vote(input) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let sql = ` update ${tablename_1.TABLE_NAME.USER} set VOTE = '${VOTE}' where ID = '${USER_ID}' `;
        try {
            yield common.query(sql);
